      ...
      <div className="p-5">
        ...
        <main className="pb-48">
          <ol className="list-decimal space-y-4 font-bold pl-5">
            <li>
              <h1>Legal Documents: (1 original copy and 2 photocopies)</h1>
              <ul className="list-disc pl-10 font-normal">
                <li>
                  <h2 className="font-bold text-[14px]">
                    Certified True Copy of Certificate of Title/Transfer
                    Certificate of Title (CTC)
                  </h2>
                  <div className="relative -left-4 text-sm leading-tight">
                    <p className="text-justify">
                      - If the LOT/PROPERTY is not in the name of the applicant
                      (any of the following): Deed of Absolute Sale, Lease
                      Purchase Agreement, Deed of Assignment, Memorandum of
                      Agreement, Extrajudicial Settlement, Authority to
                      Construct, Lease Contract or Certification from the
                      Lessor, Conditional Deed of Sale or Contract of Sale.
                    </p>
                    <p className="text-justify">
                      - If Transfer Certificate of Title (TCT) is in the name of
                      a Corporation: Secretary’s Certificate or Board Resolution
                      of Authorized Signatory for the application.
                    </p>
                    <p className="text-justify">
                      - If a Representative is applying in behalf of the
                      applicant: Notarized Authorization letter to transact with
                      OBO (with Valid ID of applicant and representative).
                    </p>
                    <p className="text-justify">
                      - If a Representative is signing in behalf of the
                      applicant: Notarized Special Power of Attorney(SPA) with
                    ...
                    <p className="text-justify">
                      - In the Absence of Approved Subdivision plan: Authority
                      to Construct.
                    </p>
                    <p className="text-justify">
                      - For Tower Crane Installation/ Firewall: Neighbor’s
                      consent.
                    </p>
                  </div>
                </li>
            ...
            <li className="font-bold">
              ...
              <ul className="list-disc pl-10 font-normal leading-tight">
                <li>
                  <h2 className="font-bold text-[14px]">
                    For Towers: CAAP clearance (1 original copy and 2
                    photocopies)
                  </h2>
                  <div className="relative -left-4 text-sm">
                    <p className="text-justify">
                      - If telecommunications Tower infrastructure is (1) in
                      excess of 50 meters height and in the direct flight plan
                      within a 3-kilometer radius of an airport; or (ii) shall
                      be constructed within the 10-kilometer radius of
                      communication-navigation surveillance facilities located
                      off-airport.
                    </p>
                    <p className="text-justify">
                      - Affidavit of Undertaking, certified by a Geodetic
                      Engineer conformed by the owner (notarized, 1 original
                      copy and 2 photocopies)attesting that the proposed
                      structure will be built outside the CAAPcritical areas for
                      towers within 50 meters height.
                    </p>
                  </div>
                </li>
                <li className="">
                  <h2 className="font-bold text-[14px]">
                    Affidavit of Undertaking Form (duly filled out and
                    notarized)
                  </h2>
                  <div className="relative -left-4">
                    <p className="text-justify text-[14px]">
                      - For other clearances to be submitted within 30 days
                      after the issuance of the Building
                    </p>
                  </div>
                </li>
              </ul>
              ...
              <ul className="list-disc pl-10 font-normal text-sm leading-tight">
                <li>
                  <h2 className="font-bold ">
                    One (1) photocopy of valid PRC ID & current PTR with seal
                    and 3 specimen signatures of the professional.
                  </h2>
                </li>
                <li>
                  <h2 className="font-bold">
                    One (1) original and 2 photocopies of Sketch Plan (with
                    clear landmarks) and Relocation Survey report.(Include
                    Structural Survey Plan if the Structure is existing).
                  </h2>
                </li>
                <li>
                  <h2 className="font-bold ">
                    Four (4) copies of system generated and notarized Unified
                    Application Form for Building Permit with
                    ancillary/accessory application forms (if applicable).
                  </h2>
                </li>
              </ul>
              ...
              <ol className="list-upperAlpha pl-10 font-normal space-y-4 text-sm leading-tight">
                <li>
                  ...
                  <ol className="list-upperRoman pl-10 font-normal pt-3">
                    ...
                    <li>
                      Sections, at least two (2), showing: gridlines; natural
                      ...
                      cabinets, etc.; identification of rooms and functional
                      spaces cut by section lines.
                    </li>
                    <li>
                    ...
                    <li>
                      Reflected ceiling plan showing: design, location, finishes
                      and specifications of materials, lighting fixtures,
                      diffusers, decorations, air conditioning exhaust and
                      return grills, sprinkler nozzles, if any, at scale of at
                      least 1:100.
                    </li>
                    <li>
                      Layout plan of each floor indicating the fire evacuation
                      route to safe dispersal areas, standpipes with fire hose,
                      fire extinguishers, first aid kits/cabinets, fire alarm,
                    ...
                    <li>Key Plan</li>
                    <li>
                      Front Elevation, same scale as floor plans showing:
                      gridlines;
                    </li>
                  ...
                  <ol className="list-upperRoman pl-10 font-normal pt-3 space-y-5">
                    ...
                    <li>
                      ...
                      <ol className="list-lowerRoman pl-10 font-normal pt-3">
                        ...
                        <li>
                          Floor/Roof Framing Plans and Details at scale of not
                          less than 1:100 Schedule of Column, Footings, Wall
                ...
                <li>
                  ...
                  <ol className="list-upperRoman pl-10 font-normal pt-3">
                    ...
                    <li>Schedule of Beams and Girders/Details</li>
                    <li>
                      Schedule of Loads, Transformers, Generating/UPS Units
                      (Total kVA for each of the preceding items shall be
                ...
                <li>
                  ...
                  <ol className="list-upperRoman pl-10 font-normal pt-3">
                    ...
                    <li>
                      Storm water drainage plan (incorporate rainwater tank)
                    </li>
                    <li>
                      Septic tank, catch basin, grease trap, cistern tank,
                      pressure tank, overhead water tank, sump pit and pump
                ...
                <li>
                  <h2>
                    Geodetic (with Sketch Plan, Relocation Survey Report except
                    for Subdivisions)
                  </h2>
                  <ol className="list-none pl-5 font-normal pt-3">
                    <li>
                      - If the Building/ Structure is existing, Submit
                      Structural Survey plan
                    </li>
                    <li>
                      - If individual title is still for approval, Submit
                      Narrative Survey report
                    </li>
                    <ol className="list-upperRoman pl-14 font-normal pt-3">
                      <li>
                        Vicinity Map/Location Plan within a 2.00-kilometer
                      ...
                      <li>
                        ...
                        utilities/services. Existing buildings within and
                        adjoining the lot shall be hatched and distances between
                    ...
                    <ol className="list-lowerRoman pl-14 font-normal pt-3">
                      ...
                      <li>
                        Detailed Topographic Plan of the site and immediate
                        vicinity
                      </li>
                    </ol>
                  </ol>
                ...
                <li>
                  ...
                  <ol className="list-upperRoman pl-10 font-normal pt-3">
                    <li>
                      Electronics plans coincide with other plans of all
                      sections
                    </li>
                ...
                <li>
                  ...
                  <ol className="list-upperRoman pl-10 font-normal pt-3">
                    ...
                    <li>
                      General Layout Plan for each floor, drawn to a scale of
                      not less than 1:100, indicating the equipment in heavier
                      lines than the building outline with names of machinery
                      and corresponding brake horsepower shall be indicated.
                    </li>
                    <li>
                    ...
                    <li>
                      Detailed Plans of machinery foundations and supports drawn
                      to scale of at least 1:50
                    </li>
                    <li>
                      Detailed plans of fire suppression systems, location of
                      automatic and smoke detectors and alarm and initiating
                      devices used to monitor the conditions that are essential
                      for the proper operation including switches for the
                      position of gate valves as well as alert and evacuation
                      signals; the detailed layout of the entire safe area to be
                      protected and the heat/smoke ventilation system
                    </li>
                    <ol className="list-lowerRoman pl-10 font-normal pt-3">
                      <li>
                      ...
                      <li>
                        If additional massive machinery like elevators,
                        escalators, generator sets, boilers, etc.:
                      </li>
                    </ol>
                    <ol className="list-lowerAlpha pl-10 font-normal pt-3">
                      <li>
                        Certificate of Structural Stability (original copy/
                        signed & sealed w/ PRC/PTR), stating the gross weight of
                        the machinery and the grid location of the structural
                        members that will support the machinery.
                      </li>
                      <li>
                        copy of approved Structural Analysis and Design
                        Computation copy of approved Structural Plans
                      </li>
                    </ol>
                  </ol>
                </li>
                <li>
                  ...
                  <ol className="list-upperRoman pl-10 font-normal pt-3">
                    ...
                    <li>
                      ...
                      Structure to be erected as declared by the owner/s (signed
                      and sealed by duly licensed professionals and signed by
                      owner/s)
                    </li>
                    <li>
                      Two (2) Sets of Technical Specifications (signed and
                      sealed by duly licensed professionals and signed by
                      owner/s)
                    </li>
                    <li>
                    ...
                    <li>
                      One (1) copy of Structural Stability Certificate for
                      existing buildings at least 15 years old (See Annex 5)
                    </li>
                    <li>
                      ...
                      <div className="relative left-4 px-3 py-5">
                        ...
                        <p className="text-justify">
                          The process of securing a Building Permit, as required
                          for COMPLEX application comprising of:
                        </p>
                        <ol className="list-decimal pl-5 font-normal pt-3">
                          <li>
                            Interior Renovations covered by an appropriate
                            Building Permit
                          </li>
                          <li>
                            Conversion of existing building occupancy
                            classification
                          </li>
                          <li>
                            Multiple unit residential houses (such as row
                            houses, townhouses, and the like)
                          </li>
                          <li>
                          ...
                          <li>
                            Demolition (any type of occupancy/ use with area of
                            more than three hundred (300) square meters)
                          </li>
                          <li>Billboard structures</li>
                          <li>
                            All other types of Occupancy not more than 9 storeys
                            and communication towers (based on JMC 1, s. 2020)
                          </li>
                        </ol>
                      </div>
                      <div className="relative left-4 px-3 pb-5">
                        ...
                        <ol className="list-decimal pl-5 font-normal pt-3">
                          ...
                          <li>
                            Special structures such as but not limited to
                            Aerodome facilities, before construction work or
                            operation can commence in compliance with the
                            National Building Code of the Philippines (PD 1096),
                            its IRR and Referral Codes, other pertinent laws,
                            and directives.
                          </li>
                        </ol>
                      </div>
                    ...
                    <li>
                      For BUILDING PERMIT – Amendatory (AS-BUILT), attach
                      Building Permit and/or Occupancy Inspection Report and 1
                      complete set of approved building plans.
                    </li>
                    <li>
                      For BUILDING PERMIT - ADDITIONAL/ REPAIR or Renovation,
                      attach Building permit and/or Certificate of Occupancy and
                      1 complete set of approved building plans.
                    </li>
                    <div className="relative left-4 px-3 p-5">
                      ...
                      <ol className="list-decimal pl-14 font-normal pt-3">
                        ...
                        <li>
                          ...
                          Green Building Code (PGBC) with the required minimum
                          Total Gross Floor Area (TGFA).
                        </li>
                        <li>
                          – see Table 1, Section 8 of PGBC for minimum TGFA in
                          Annex 4
                        </li>
                        <li>
                          Malls, Hospitals and other Public Buildings such as
                          City Hall, Sangguniang Panlungsod, Central Public
                          Market, Fishport Complex, Colleges and Universities,
                          Public Transportation Terminal, Camp Fermin Lira, and
                          the Philippine National Police XII Headquarters
                          located within the Territorial Jurisdiction of General
                          Santos City to Provide Prayer Rooms for Muslims as per
                          Ordinance No. 19 Series of 2022. (See Annex 7)
                        </li>
                        <li>
                          The design should incorporate requirements for
                          Earthquake Recording Instrumentation (ERI), based on
                          EO No. 1, s. 2020. See Annex 3
                        </li>
                      </ol>
                    </div>
